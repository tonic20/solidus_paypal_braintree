...
$(document).ready(function() {
  if (document.getElementById("empty-cart")) {
    $.when(
      ...
      $.getScript("https://js.braintreegateway.com/web/3.76.2/js/paypal-checkout.min.js"),
      $.getScript("https://js.braintreegateway.com/web/3.76.2/js/data-collector.min.js")
    ).done(function() {
